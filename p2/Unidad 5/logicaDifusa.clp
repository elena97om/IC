...
(cd edad menor 0 0 20 25)		 ; aproximadamente menos de 20
(cd edad medio 25 30 60 65)	 ;aproximadamente entre 30 y 60
(cd edad mayor 70 80 90 100) ;aproximadamente mayor de 70
)
...
(regla 5 antecedente edad mayor)
(regla 5 consecuente dosis alta)
(regla 5 explicacion "Si la edad es mayor de 70, la dosis a aplicar es alta")
)
